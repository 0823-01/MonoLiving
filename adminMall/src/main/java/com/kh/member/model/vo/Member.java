...
public class Member {
    ...
    // 회원 정보 수정용 생성자 (매개변수 6개짜리)
    public Member(String userId, String userName, String phone, String email, String address, String gender) {
        this.userId = userId;
        this.userName = userName;
        this.phone = phone;
        this.email = email;
    ...
    // 회원 목록 조회용 생성자
    public Member(int userNo, String userId, String email, Date enrollDate, String status) {
  		super();
  		this.userNo = userNo;
  		this.userId = userId;
  		this.email = email;
