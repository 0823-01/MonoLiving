...
public class ProductListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수
		 listCount = new ProductInfoService().selectProductCount();
		...
		list = new ProductInfoService().selectList(pi);
		...
		// 상품 목록 조회 화면 포워딩
		request.getRequestDispatcher("/views/product/AdProductList.jsp").forward(request, response);
