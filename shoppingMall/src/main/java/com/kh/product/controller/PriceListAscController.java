...
/**
 * Servlet implementation class PriceListAscController
 */
@WebServlet("/priceListAsc.pr")
public class PriceListAscController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PriceListAscController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// ----- 페이징 처리 ------
				...
				request.getRequestDispatcher("/views/product/prcieAscList.jsp").forward(request, response);
	}
